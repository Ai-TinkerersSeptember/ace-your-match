-- Make location completely optional for matching
-- Add a preference to enable/disable location-based matching

-- Add location_enabled column to user_preferences
ALTER TABLE user_preferences 
ADD COLUMN location_enabled BOOLEAN DEFAULT true;
...
-- Update the get_potential_matches function to respect location preferences
