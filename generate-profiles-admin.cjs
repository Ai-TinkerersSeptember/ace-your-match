...
if (!supabaseUrl || !supabaseKey) {
  ...
  console.log('⚠️  Make sure to use the SERVICE_ROLE key (not the anon key) for this script');
  process.exit(1);
}
...
const generateAllProfiles = async () => {
  ...
  console.log('⚠️  Using SERVICE ROLE key - this bypasses Row Level Security');
  ...
  try {
    ...
    console.log('\n🎉 Successfully generated and inserted 300 user profiles!');
    console.log(`📊 Stats:
    ...
    console.log('🎮 Your app now has 300 dummy users ready for testing!');
